...
export default function MuhurtaForm({ show, onHide, item, refresh }) {
  const empty = {
    title: "",
    slug: "",
    img: "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (item) await api.put(`/muhurta/${item.id}`, payload);
    else await api.post("/muhurta", payload);
  ...
  return (
    <Modal show={show} onHide={onHide} centered size="lg" backdrop="static">
      <Modal.Header closeButton>
        <Modal.Title>{item ? "Edit Muhurta" : "Add Muhurta"}</Modal.Title>
      </Modal.Header>
        ...
        <Form onSubmit={handleSubmit}>
          <div className="row g-3">
            <div className="col-md-6">
              ...
              {form.img && (
                <img src={form.img} alt="" style={{ width: "100%", height: 140, objectFit: "cover", borderRadius: 6 }} />
              )}
